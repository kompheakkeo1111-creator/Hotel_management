<div class="d-flex justify-content-between align-items-center mb-4">
    <div><h2 class="page-title mb-1">Room Types</h2><p class="page-subtitle mb-0"><?php echo count($roomTypes); ?> room categories</p></div>
    ...
    <table class="table table-hover align-middle mb-0">
        ...
        <?php foreach ($roomTypes as $t): ?>
            <tr>
                ...
                <td class="text-center"><span class="badge bg-secondary"><?php echo (int)$t['capacity']; ?></span></td>
                <td class="text-center"><?php echo (int)$t['room_count']; ?></td>
                <td class="text-end">
        ...
        <?php endforeach; ?>
        <?php if (!$roomTypes): ?><tr><td colspan="7" class="text-center text-muted py-4">No room types found.</td></tr><?php endif; ?>
        </tbody>
    </table>
</div></div></div>
...
<script>
const typeData = <?php echo json_encode($roomTypes); ?>;
